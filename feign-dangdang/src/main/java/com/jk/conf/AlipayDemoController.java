...
public class AlipayDemoController {
    ...
    public String goAlipay(HttpServletRequest request, HttpServletRequest response) throws Exception {
        ...
        order.setOrdernumber("12019092316513002191297750097160");
        order.setOrderstatus(4);
        order.setOrderdate(new Date());
        order.setOrderprice(22.0);
        order.setOrderallid("1");
        order.setBookcount(5);
        ...
        //订单名称，必填
        String subject = order.getOrdernumber();
        //商品描述，可空
        String body = "";
